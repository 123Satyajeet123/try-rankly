...
export function PlatformsTab({ range, realLLMData, realPlatformData, dateRange = '30 days', isLoading = false }: PlatformsTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <UnifiedTrafficPerformanceSection realPlatformData={realPlatformData} dateRange={dateRange} isLoading={isLoading} />
      ...
      <UnifiedLLMPlatformPerformanceSection realLLMData={realLLMData} dateRange={dateRange} isLoading={isLoading} />
    </div>
  )
}