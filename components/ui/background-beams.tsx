  ...
  ({ className }: BackgroundBeamsProps) => {
    ...
    return (
      ...
      >
        ...
        <motion.div
          className="absolute w-64 h-64 rounded-full bg-foreground/5 blur-3xl pointer-events-none"
          animate={{
        ...
        <motion.div
          className="absolute w-32 h-32 rounded-full bg-foreground/3 blur-2xl pointer-events-none"
          animate={{
